...
# PYTHONOPTIMIZE=2 python .\main.py -device cuda:0 -lr 0.001 -bs 10 -epochs 200 -dataset cifar10 -data_path ../data -scheduler IncreaseBSOnPlateau -scheduler_params "{'mode':'min', 'factor':2}" -model preresnet18_c10 -fill 0.5 --cutout --autoaug --tta --half # noqa: E501

...
# python main.py -device cuda:0 -lr 0.001 -bs 16 -epochs 200 -dataset cifar100noisy -data_path ../data -scheduler StepLR -scheduler_params "{'step_size':30, 'gamma': 2.0}" -model preresnet18_c10 -fill 0.5 --cutout --autoaug --tta --half # noqa: E501

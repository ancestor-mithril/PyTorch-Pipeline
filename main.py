...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-es_patience", default=20, type=int, help="early stopping patience"
    )
    ...
    parser.add_argument(
        "-scheduler_params", default="{}", type=str, help="scheduler_params"
    )
    ...
    parser.add_argument(
        ...
        default="mean",
        type=str,
        help="loss reduction. Can be mean, iqr, stdmean.",
    )
    parser.add_argument(
        "-loss_scaling",
        default=None,
    ...
    parser.add_argument(
        ...
        default=None,
        type=int,
        help="default number of threads used by pytorch",
    )
    parser.add_argument("-seed", default=3, type=int, help="seed")
    parser.add_argument(
        "-clip_value", default=None, type=float, help="value for gradient clipping"
    )
    parser.add_argument(
        "--cutout", action="store_true", default=False, help="apply cutout"
    )
    parser.add_argument(
        "--autoaug", action="store_true", default=False, help="apply autoaugment"
    )
